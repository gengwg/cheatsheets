...
1. Go to `about:config`
2. Toggle the “browser.tabs.insertAfterCurrent” switch to “true” (default is “false”)
[stefanjudis](https://www.stefanjudis.com/notes/open-new-tabs-next-to-the-current-one-in-firefox/)
